                ...
                <div class="col-12 col-md-8">
                    <div class="card p-4 shadow-sm h-100">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="radio" name="khu_vuc_lam_viec" id="kvnn" value="Nhà nước">
                                <label class="form-check-label" for="kvnn">Khu vực nhà nước</label>
                            </div>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="radio" name="khu_vuc_lam_viec" id="kvtntn" value="Tư nhân">
                                <label class="form-check-label" for="kvtntn">Khu vực tư nhân</label>
                            </div>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="radio" name="khu_vuc_lam_viec" id="kvefdi" value="Có yếu tố nước ngoài">
                                <label class="form-check-label" for="kvefdi">Có yếu tố nước ngoài</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="khu_vuc_lam_viec" id="kvstart" value="Tự tạo việc làm">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="radio" name="thoigian_co_viec" id="tgduoi3" value="Dưới 3 tháng">
                                <label class="form-check-label" for="tgduoi3">Dưới 3 tháng</label>
                            </div>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="radio" name="thoigian_co_viec" id="tg3_6" value="Từ 3-6 tháng">
                                <label class="form-check-label" for="tg3_6">Từ 3 tháng đến 6 tháng</label>
                            </div>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="radio" name="thoigian_co_viec" id="tg6_12" value="Từ 6-12 tháng">
                                <label class="form-check-label" for="tg6_12">Từ 6 tháng đến 12 tháng</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="thoigian_co_viec" id="tgtren12" value="Trên 12 tháng">
                        ...
                        <div class="mb-3">
                            <label class="form-label">17. Công việc Anh/Chị đang làm có phù hợp với ngành đào tạo không?</label>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="radio" name="phuhop_nganh" id="phuhop_dung" value="Đúng ngành">
                                <label class="form-check-label" for="phuhop_dung">Đúng ngành đào tạo</label>
                            </div>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="radio" name="phuhop_nganh" id="phuhop_lienquan" value="Liên quan">
                                <label class="form-check-label" for="phuhop_lienquan">Liên quan đến ngành đào tạo</label>
                            </div>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="radio" name="phuhop_nganh" id="phuhop_khonglienquan" value="Không liên quan">
                                <label class="form-check-label" for="phuhop_khonglienquan">Không liên quan đến ngành đào tạo</label>
                            </div>
                        </div>

                        <!-- 18. Công việc có phù hợp với trình độ chuyên môn -->
                        <div class="mb-3">
                            <label class="form-label">18. Công việc Anh/Chị đang đảm nhận có phù hợp với trình độ chuyên môn không?</label>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="radio" name="phuhop_trinhdo" id="trinhdo_chua" value="Chưa phù hợp">
                                <label class="form-check-label" for="trinhdo_chua">Chưa phù hợp với trình độ chuyên môn</label>
                            </div>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="radio" name="phuhop_trinhdo" id="trinhdo_phuhop" value="Phù hợp">
                                <label class="form-check-label" for="trinhdo_phuhop">Phù hợp với trình độ chuyên môn</label>
                            </div>
                        </div>

                        <!-- 19. Kiến thức kỹ năng từ trường có phù hợp công việc -->
                        <div class="mb-3">
                            <label class="form-label">19. Anh/Chị có học được kiến thức/kỹ năng cần thiết từ trường cho công việc không?</label>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="radio" name="kienthuc_tu_truong" id="kt_hocduoc" value="Đã học được">
                                <label class="form-check-label" for="kt_hocduoc">Đã học được</label>
                            </div>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="radio" name="kienthuc_tu_truong" id="kt_khonghocduoc" value="Không học được">
                                <label class="form-check-label" for="kt_khonghocduoc">Không học được</label>
                            </div>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="radio" name="kienthuc_tu_truong" id="kt_motphan" value="Chỉ học được 1 phần">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="radio" name="thu_nhap_hientai" id="tn_duoi5" value="Dưới 5 triệu">
                                <label class="form-check-label" for="tn_duoi5">Dưới 5 triệu</label>
                            </div>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="radio" name="thu_nhap_hientai" id="tn_5_10" value="5 - 10 triệu">
                                <label class="form-check-label" for="tn_5_10">Từ 5 triệu - 10 triệu</label>
                            </div>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="radio" name="thu_nhap_hientai" id="tn_10_15" value="10 - 15 triệu">
                                <label class="form-check-label" for="tn_10_15">Từ 10 triệu - 15 triệu</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="thu_nhap_hientai" id="tn_tren15" value="Trên 15 triệu">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" name="hinh_thuc_tim_viec[]" id="ht_1" value="Do Học viện/Khoa giới thiệu">
                                <label class="form-check-label" for="ht_1">Do Học viện/Khoa giới thiệu</label>
                            </div>

                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" name="hinh_thuc_tim_viec[]" id="ht_2" value="Bạn bè, người quen giới thiệu">
                                <label class="form-check-label" for="ht_2">Bạn bè, người quen giới thiệu</label>
                            </div>

                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" name="hinh_thuc_tim_viec[]" id="ht_3" value="Tự tìm việc làm">
                                <label class="form-check-label" for="ht_3">Tự tìm việc làm</label>
                            </div>

                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" name="hinh_thuc_tim_viec[]" id="ht_4" value="Tự tạo việc làm">
                                <label class="form-check-label" for="ht_4">Tự tạo việc làm</label>
                            </div>

                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="hinh_thuc_tim_viec[]" id="ht_5" value="Khác">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="radio" name="hinh_thuc_tuyen" id="thi_tuyen" value="Thi tuyển">
                                <label class="form-check-label" for="thi_tuyen">Thi tuyển</label>
                            </div>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="radio" name="hinh_thuc_tuyen" id="xet_tuyen" value="Xét tuyển">
                                <label class="form-check-label" for="xet_tuyen">Xét tuyển</label>
                            </div>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="radio" name="hinh_thuc_tuyen" id="hop_dong" value="Hợp đồng">
                                <label class="form-check-label" for="hop_dong">Hợp đồng</label>
                            </div>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="radio" name="hinh_thuc_tuyen" id="dieu_dong" value="Điều động">
                                <label class="form-check-label" for="dieu_dong">Điều động</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="hinh_thuc_tuyen" id="khac_tuyen" value="Khác">
                        ...
                        <div class="mb-4">
                            ...
                            @php $ky_nang = [
                                'Kỹ năng giao tiếp', 'Kỹ năng lãnh đạo', 'Kỹ năng thuyết trình', 'Kỹ năng Tiếng Anh',
                                'Kỹ năng làm việc nhóm', 'Kỹ năng tin học', 'Kỹ năng viết báo cáo tài liệu',
                                'Kỹ năng hội nhập quốc tế', 'Khác'
                            ]; @endphp

                            @foreach($ky_nang as $index => $value)
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" name="ky_nang_mem[]" id="kn_{{ $index }}" value="{{ $value }}">
                                <label class="form-check-label" for="kn_{{ $index }}">{{ $value }}</label>
                            </div>
                            @endforeach
                        </div>
                        ...
                        <div class="mb-4">
                            <label class="form-label fw-bold">
                                25. Sau khi được tuyển dụng, Anh/Chị có phải tham gia khóa học nâng cao nào dưới đây để đáp ứng công việc không?
                                <span class="fw-normal">(Có thể chọn nhiều lựa chọn)</span>
                            </label>

                            @php $nang_cao = [
                                'Nâng cao kiến thức chuyên môn', 'Nâng cao kỹ năng chuyên môn nghiệp vụ',
                                'Nâng cao về kỹ năng công nghệ thông tin', 'Nâng cao kỹ năng ngoại ngữ',
                                'Phát triển kỹ năng quản lý', 'Tiếp tục học lên cao', 'Khác'
                            ]; @endphp

                            @foreach($nang_cao as $index => $value)
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" name="khoa_hoc_nang_cao[]" id="nc_{{ $index }}" value="{{ $value }}">
                                <label class="form-check-label" for="nc_{{ $index }}">{{ $value }}</label>
                            </div>
                            @endforeach
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            @php $giai_phap = [
                                'Học viện tổ chức các buổi trao đổi, chia sẻ kinh nghiệm việc làm giữa cựu sinh viên và sinh viên',
                                'Học viện tổ chức các buổi gặp gỡ với đơn vị sử dụng lao động',
                                'Đơn vị sử dụng lao động tham gia vào quá trình đào tạo',
                                'Chương trình đào tạo được cập nhật theo nhu cầu thị trường',
                            ...
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" name="giai_phap_viec_lam[]" id="gp_{{ $index }}" value="{{ $value }}">
                                <label class="form-check-label" for="gp_{{ $index }}">{{ $value }}</label>
                            </div>
                            @endforeach
                        </div>
