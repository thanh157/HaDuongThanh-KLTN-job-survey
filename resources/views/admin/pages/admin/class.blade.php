        ...
        <div class="row gy-4">
            ...
            <div class="col-md-6">
                <div class="card shadow-sm border-start border-4 border-primary h-100 class-card"
                    data-href="{{ route('admin.class.class-detail', ['id' => 2]) }}" style="cursor: pointer;">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start">
                            ...
                            <div class="d-flex flex-column gap-1">
                                <a href="{{ route('admin.class.edit-class', ['id' => 2]) }}"
                                    class="btn btn-sm btn-outline-primary" title="Sửa" onclick="event.stopPropagation()">
            ...
            <div class="col-md-6">
                <div class="card shadow-sm border-start border-4 border-success h-100 class-card"
                    data-href="{{ route('admin.class.class-detail', ['id' => 1]) }}" style="cursor: pointer;">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                ...
                                <ul class="list-unstyled small mb-0">
                                    ...
                                    <li>Hiện tại: <strong>640 SV</strong></li>
                                </ul>
                            </div>
                            <div class="d-flex flex-column gap-1">
                                <a href="{{ route('admin.class.edit-class', ['id' => 1]) }}"
                                    class="btn btn-sm btn-outline-primary" title="Sửa" onclick="event.stopPropagation()">
                                    <i class="bi bi-pencil-square"></i>
                                </a>
                                <button class="btn btn-sm btn-outline-danger" title="Xóa"
            ...
            <div class="col-md-6">
                <div class="card shadow-sm border-start border-4 border-success h-100 class-card"
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                <h5 class="card-title mb-1">Khóa 67</h5>
                                <p class="text-muted mb-2">Năm: 2022</p>
                                <ul class="list-unstyled small mb-0">
                                    <li>Tổng số lớp: <strong>8</strong></li>
                                    <li>Nhập học: <strong>800 SV</strong></li>
                                    <li>Hiện tại: <strong>628 SV</strong></li>
                                </ul>
                            </div>
                            <div class="d-flex flex-column gap-1">
                                <a href="{{ route('admin.class.edit-class', ['id' => 1]) }}"
            ...
            <div class="col-md-6">
                <div class="card shadow-sm border-start border-4 border-success h-100 class-card"
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                <h5 class="card-title mb-1">Khóa 66</h5>
                                <p class="text-muted mb-2">Năm: 2021</p>
                                <ul class="list-unstyled small mb-0">
                                    <li>Tổng số lớp: <strong>7</strong></li>
                                    <li>Nhập học: <strong>522 SV</strong></li>
                                    <li>Hiện tại: <strong>450 SV</strong></li>
                                </ul>
                            </div>
                            <div class="d-flex flex-column gap-1">
                                <a href="{{ route('admin.class.edit-class', ['id' => 1]) }}"
