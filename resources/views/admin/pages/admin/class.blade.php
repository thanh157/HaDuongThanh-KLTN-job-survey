    ...
    <div class="row gy-4">
        ...
        @forelse ($filtered as $class)
            <div class="col-md-6 col-xl-4">
                <a href="{{ route('admin.class.class-detail', ['id' => $class['id']]) }}" class="text-decoration-none">
                    <div class="card class-card h-100">
                        <div class="card-body position-relative">
                            ...
                            <ul class="list-unstyled small mb-0">
                                <li class="mb-1"><i class="bi bi-diagram-3-fill text-secondary me-2"></i> Tổng số lớp: {{ $class['tong_so_lop'] }}</li>
                                <li class="mb-1"><i class="bi bi-person-plus-fill text-success me-2"></i> Nhập học: {{ $class['nhap_hoc'] }}</li>
                                <li><i class="bi bi-people-fill text-info me-2"></i> Hiện tại: {{ $class['hien_tai'] }}</li>
                            </ul>
