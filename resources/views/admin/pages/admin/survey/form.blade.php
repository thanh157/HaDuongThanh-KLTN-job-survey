        ...
        <div class="google-form-style ">
            ...
            <form>
                <div class="form-section">
                    ...
                    <label for="ho_ten">1. Họ và tên</label>
                    <input type="text" class="form-control" id="ho_ten" name="ho_ten"
                        placeholder="Nhập họ và tên đầy đủ" value="{{ old('ho_ten') }}">
                </div>
                            ...
                            @foreach ($question->options as $optIndex => $option)
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="radio" name="answers[{{ $question->id }}]"
                                        id="q{{ $question->id }}_{{ $optIndex }}" value="{{ $option['text'] }}"
                                        data-is-other="{{ $option['is_other'] ? 'true' : 'false' }}">
                                    <label class="form-check-label" for="q{{ $question->id }}_{{ $optIndex }}">
                                        {{ $option['text'] }}
                                    </label>
                                    @if ($option['is_other'])
                                        <input type="text" class="form-control mt-2 d-none other-input"
